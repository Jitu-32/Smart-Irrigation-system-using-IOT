// We wrote the server connection code with the help of tutorials provided
// on the website of Thingspeak server. 
...
const char *ssid =  "IITRopar";     // Enter your WiFi Name
const char *pass =  "Sprinklers"; // Enter your WiFi Password
...
void setup()
{
  ...
  digitalWrite(motorPin, LOW); //  motor off initally
  dht.begin();
